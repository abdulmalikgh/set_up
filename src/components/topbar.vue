...
<template>
	<div class="navbar navbar-expand flex-column flex-md-row navbar-custom " style="background-color:#FBFBFB">
		<div class="container-fluid">
			...
			<ul class="navbar-nav flex-row ml-auto d-flex list-unstyled topnav-menu float-right mb-0">
				...
				<li>
					<div class="help mt-4">
						<button class="help-btn"><i class="fas fa-question-circle" style="font-size:24px; color:#D4D8E2"></i></button>
					</div>
				</li>
				<b-nav-item-dropdown
					id="globe-tooltip"
				...
				<b-nav-item-dropdown 
					...
					<b-dropdown-item href="/profile-settings">Profile</b-dropdown-item>
