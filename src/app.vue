...
.verify_pin, .verify_pin input {
  width: 40px;
  height: 48px;
}
.wrong_number button, .resend-code{
  padding-bottom: 20px;
  color:#6D22F2;
  font-weight: bolder;
  font-size: 16px;
...
.did_not_receive_code, .call_instead{
  font-size: 14px;
  font-style: normal;
  font-weight: 400;
  line-height: 21px;
...
#mNotify__form_fields_container, #mNotify__signin__form_fields_container{
    width:60%;
    height: 100%;
    display: flex;
